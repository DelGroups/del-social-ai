...
class Permission(enum.StrEnum):
    ...
    MANAGE_MEDIA = "manage_media"  # upload, frame and delete photos and the logo
...
_ADMIN = _APPROVER | {Permission.MANAGE_CONNECTIONS, Permission.MANAGE_BRAND, Permission.MANAGE_MEDIA, Permission.MANAGE_MEMBERS, Permission.VIEW_USAGE}
